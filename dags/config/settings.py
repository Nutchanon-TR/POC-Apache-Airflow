...
config/settings.py
==================
Centralized configuration. All tunables live here.
DAG files and task modules import from here — never hardcode values elsewhere.
"""
...
# ─── Thresholds ────────────────────────────────────────────────────────
HOT_THRESHOLD_C  = 35   # temp_max >= this → hot_flag
COLD_THRESHOLD_C = 10   # temp_min <= this → cold_flag
