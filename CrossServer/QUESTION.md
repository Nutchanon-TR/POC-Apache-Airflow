...
A: ใช้แล้ว โดย `trigger_ct2_dag()` อ่าน `CT2-AIRFLOW-URL`, `CT2-AIRFLOW-USER`, `CT2-AIRFLOW-PASSWORD` จาก Key Vault
...
Q: nested try/finally ใช้ทำไร?
A: ให้แน่ใจว่า SFTP และ SSH จะถูกปิดเสมอไม่ว่าจะ error หรือไม่
